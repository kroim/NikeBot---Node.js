...
!function (N) {
    ...
    var e = /^#([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i, G = function (t) {
    ...
    function J(i, d) {
        ...
        var g, n, m, h, v, t, r = N("<div/>").addClass("jq-ry-group-wrapper").appendTo(i),
            ...
            a = N("<div/>").addClass("jq-ry-rated-group").addClass("jq-ry-group").appendTo(r), w = 0, o = d.rating, l = !1;
        ...
        function u(t) {
            var r = d.starWidth = t;
            return n = window.parseFloat(d.starWidth.replace("px", "")), y.find("svg").attr({width: d.starWidth, height: r}), a.find("svg").attr({
                width: d.starWidth,
                height: r
            }), c(), i
        }
        ...
        function p(t) {
            return d.spacing = t, h = parseFloat(d.spacing.replace("px", "")), y.find("svg:not(:first-child)").css({"margin-left": t}), a.find("svg:not(:first-child)").css({"margin-left": t}), c(), i
        }

        function f(t) {
            return d.normalFill = t, (d.rtl ? a : y).find("svg").attr({fill: d.normalFill}), i
        }
        ...
        function k(t) {
            if (d.multiColor) {
                var r = (o - w) / d.maxValue * 100, e = d.multiColor || {};
                t = function (t, r, e) {
                    if (!t || !r) return null;
                    e = D(e) ? e : 0, t = G(t), r = G(r);
                    var n = H(t.r, r.r, e), a = H(t.b, r.b, e);
                    return "#" + n + H(t.g, r.g, e) + a
                }(e.startColor || X.startColor, e.endColor || X.endColor, r)
            } else b = t;
            return d.ratedFill = t, (d.rtl ? y : a).find("svg").attr({fill: d.ratedFill}), i
        }
        ...
        function I(t) {
            var r, e, n, a, i, o = y.offset().left, l = o + y.width(), s = d.maxValue, c = t.pageX, u = 0;
        ...
        function E(t) {
            ...
            }(r, w, e), r = parseFloat(r.toFixed(d.precision)), $(parseFloat(r), w, e), d.rating = r, s(), l && i.trigger("rateyo.set", {rating: r}), i
        }
        ...
        this.rating = function (t) {
            ...
            return d.readOnly || L(), J.prototype.collection = (n = i.get(0), a = this.collection, N.each(a, function (t) {
                if (n === this.node) {
                    var r = a.slice(0, t), e = a.slice(t + 1, a.length);
            ...
            return D(r) ? e(r) : d[t]
        }, C(d.numStars), V(d.readOnly), d.rtl && x(d.rtl), this.collection.push(this), this.rating(d.rating, !0), l = !0, i.trigger("rateyo.init", {rating: d.rating})
    }
    ...
    J.prototype.collection = [], window.RateYo = J, N.fn.rateYo = function () {
        return function (e) {
            var i = J.prototype.collection, t = N(this);
